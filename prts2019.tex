...
C'est la somme d'une série géométrique : \[\sum_{k=0}^{\infty} x^k = \frac{1}{1-x}, \text{ si} \left\vert x \right\vert < 1 \]} %\pause 
\onslide<5->{Donc dans notre cas : \[ T = 10 \cdot \frac{1}{1- 1/2} = 10\cdot 2 = 20 \]}
\end{frame}
