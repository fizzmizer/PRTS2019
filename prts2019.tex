...
\raisebox{-2ex}{\includegraphics[height=15ex]{images/UMons-Rouge.png}\hspace{2em}}%
\\
\vspace{2ex}
}
...
\begin{tikzpicture}
\caneva{12}{9}{white}
\node at (-3.2,-0.1) {\includegraphics[scale=.4]{images/enth/th4.pdf}};
\node at (3.2,-0.1) {\includegraphics[scale=.4]{images/enth/en4.pdf}};
\node at (-3.2,4) {\textcolor{ForestGreen}{Science}};
\node at (3.2,4) {\textcolor{ForestGreen}{Enquête}};
...
\parachute
\end{scope}
\draw (-2,0) node{\includegraphics[scale=0.05]{images/antoine.jpg}};
\end{scope}
\begin{scope}[yshift=2.5cm]
\draw (2,0) node{\includegraphics[scale=0.08]{images/elephant.jpg}};
\end{scope}
}
...
\begin{scope}[yshift=2.5cm]
\draw (-2,0) node{\includegraphics[scale=0.05]{images/antoine.jpg}};
\draw (-0.97,0.4) node{\includegraphics[scale=0.5]{images/help.pdf}};
\end{scope}
\begin{scope}[yshift=2.5cm]
\begin{scope}[xshift=2cm,yshift=0.8cm,scale=0.5]
\parachute
...
%\only<8->{\draw (-1.08,-1) node{\includegraphics[scale=0.5]{images/help.pdf}};}
